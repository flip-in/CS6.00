...
##    print s.member(41)
##    print s
##    print s.vals  #Evil because can cause \
##                #program to break if implementation is changed \
##                # 'data hiding' \
##                # no direct access to instance variable
##    
import datetime

#inheritance
#abstractions that cover shared attributes of members of the class

class Person(object): #most general abstraction for our class
...
####him.birthday = '8/4/61' #exception for directly accessing instance variable
##print her.getAge()
##print him.getAge()
##print him < her
##print me < her
...
##for p in pList:
##    print '  ' + str(p)
##pList.sort() #uses __lt__ to sort the objects
##print 'The people in pList are:'
##for p in pList:
##    print '  ' + str(p)

class MITPerson(Person): #inherits the properties of super class
    nextIdNum = 0 #class variable, not associated with an instance of MITPerson
    def __init__(self, name):
    ...
    def getIdNum(self):
        return self.idNum
    def __lt__(self, other): #0verride from before __lt__
...
##p4 = Person('Sue Yuan')
##print 'p1 < p2 =', p1 < p2 #compares IDs
##print 'p3 < p2 =', p3 < p2 #compares IDs
##print '_lt__(p1, p2) =', Person.__lt__(p1, p2) #uses superclass __lt__ for comparison
##print 'p1 == p4 =', p1 == p4
##print 'p4 < p3 =', p4 < p3
##print 'p3 < p4 =', p3 < p4 #exception because p4 is not MITPerson, and has no Id number
                            #executes __lt__ for MITPerson first because p3
class UG(MITPerson):
    def __init__(self, name):
        MITPerson.__init__(self, name)
        self.year = None
    def setYear(self, year):
        if year > 5: #no undergrad should be year greater than 5
...
class G(MITPerson):
    pass #MITPerson with no special properties
...
class CourseList(object):
    ...
    def addStudent(self, who):
        if not who.isStudent(): #calls from Person class
